function returnedmappings = getDatabaseMappings_update(field,qualifiers)
...
%% add databate:inchikey(AVWRKZWQTYIKIY-UHFFFAOYSA-M)
mappings(46,1) = {'inchikey'};
mappings(46,2) = {'is'};
mappings(46,3) = {'metInchikey'};
mappings(46,4) = {'met'};
mappings(46,5) = {'^[a-zA-Z0-9]+-[A-Z0-9]+-[a-zA-Z]$'};
mappings(46,6) = {'bioQualifier'};
